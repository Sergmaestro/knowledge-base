    ...
    <div class="space-y-8">
      ...
      <div v-if="overallProgress" class="bg-white rounded-lg shadow p-6">
        ...
        <p class="text-sm text-gray-600 mt-2">
          {{ overallProgress.completed }} of {{ overallProgress.total }} questions completed ({{ overallProgress.percentage }}%)
        </p>
      </div>
        ...
        >
          ...
          <div v-if="topic.progress" class="mt-4">
            <div class="flex items-center justify-between text-sm mb-1">
              ...
              <span class="font-medium" :class="topic.progress.completed === topic.progress.total ? 'text-green-600' : 'text-gray-900'">
